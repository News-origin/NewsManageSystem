...
<html>
  <head>
	...
	<link href="css/newsAuthor.css" rel="stylesheet" type="text/css">
	<script type="text/javascript" src="js/newsAuthor.js"></script>
	<title>新闻编辑者界面</title>
  </head>
		    ...
		    <div class="middle">
		        <div class="middle_left">
		            <ul>
			            ...
			            <li><a href="/NewsManageSystem/addNews.jsp">添加新闻</a></li>
		      ...
		      <div id="manageNews" class="middle_right">
